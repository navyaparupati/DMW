        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                            ...
                            <a class="nav-link" href="users_home.jsp">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="uprofile.jsp">Profile</a>
                        </li>
					     <li class="nav-item">
                            <a class="nav-link" href="paymethods.jsp">Payment Methods</a>
                        </li>
					     <li class="nav-item">
                            <a class="nav-link" href="getnoti.jsp">Notifications</a>
                        </li>
                                <li class="nav-item">
