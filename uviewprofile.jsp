...
<%
	 ...
	 String m=request.getParameter("id");
                                                       ...
                                                       {
                                                               out.println("<script>alert('Doantion Completed Successfully')</script>");
                                                       }
...
<br>	<tr><TD>
<form method="post" action="donation.jsp">
<input type="hidden" name="oname" value="<%=rs.getString("name")%>">
<input type="hidden" name="oemail" value="<%=email%>">
	<input type="submit" value="Donation" bgcolor="red">
</form>
<br>	<tr><TD>
